...
@section('content')
    ...
    <div class="max-width-1200">
        <div class="flexbox-annotated-section">
            <div class="flexbox-annotated-section-annotation">
                <div class="annotated-section-title pd-all-20">
                    <h2>{{ trans('plugins/auto-content-openai::content.setting.generate') }}</h2>
                </div>
                <div class="annotated-section-description pd-all-20 p-none-t">
                    <p class="color-note">{{ trans('plugins/auto-content-openai::content.setting.generate_description') }}</p>
                </div>
            </div>
            ...
            <div class="flexbox-annotated-section-content">
                <div class="wrapper-content pd-all-20">
                    <div class="form-group mb-3">
                        <label>{!! trans('plugins/auto-content-openai::content.setting.openai_key') !!}</label>
                    ...
                    <div class="form-group mb-3">
                        <label class="text-title-field"
                            for="autocontent_openai_temperature">{{ trans('plugins/auto-content-openai::content.setting.openai_temperature') }}
                        </label>
                        {!! Form::text('autocontent_openai_temperature', setting('autocontent_openai_temperature'), [
                            'placeholder' => trans('plugins/auto-content-openai::content.setting.openai_temperature'),
                            'class' => 'next-input',
                        ]) !!}
                    </div>
                    {{-- <div class="form-group mb-3">
                        <label class="text-title-field"
                            for="autocontent_openai_max_tokens">{{ trans('plugins/auto-content-openai::content.setting.openai_max_tokens') }}
                        </label>
                        {!! Form::text('autocontent_openai_max_tokens', setting('autocontent_openai_max_tokens'), [
                            'placeholder' => trans('plugins/auto-content-openai::content.setting.openai_max_tokens'),
                            'class' => 'next-input',
                        ]) !!}
                    </div> --}}
                    <div class="form-group mb-3">
                        <label class="text-title-field"
                            for="autocontent_openai_frequency_penalty">{{ trans('plugins/auto-content-openai::content.setting.openai_frequency_penalty') }}
                        </label>
                        {!! Form::text('autocontent_openai_frequency_penalty', setting('autocontent_openai_frequency_penalty'), [
                            'placeholder' => trans('plugins/auto-content-openai::content.setting.openai_frequency_penalty'),
                            'class' => 'next-input',
                        ]) !!}
                    </div>
                    <div class="form-group mb-3">
                        <label class="text-title-field"
                               for="autocontent_openai_api_url">{{ trans('plugins/auto-content-openai::content.setting.openai_api_url') }}
                        </label>
                        {!! Form::text('autocontent_openai_api_url', setting('autocontent_openai_api_url'), [
                            'placeholder' => trans('plugins/auto-content-openai::content.setting.openai_api_url'),
                            'class' => 'next-input',
                        ]) !!}
                    </div>
                    <div class="form-group mb-3">
                        <label class="text-title-field"
                            for="autocontent_openai_presence_penalty">{{ trans('plugins/auto-content-openai::content.setting.openai_presence_penalty') }}
                        </label>
                        {!! Form::text('autocontent_openai_presence_penalty', setting('autocontent_openai_presence_penalty'), [
                            'placeholder' => trans('plugins/auto-content-openai::content.setting.openai_presence_penalty'),
                            'class' => 'next-input',
                        ]) !!}
                    </div>
                    <div class="form-group mb-3">
                        <label class="text-title-field"
                            for="autocontent_openai_models">{{ trans('plugins/auto-content-openai::content.setting.openai_model') }}
                        </label>
                        <div class="form-group mb-3" id="openai-model-wrapper"
                            ...
                            <a id="add-model" class="link" data-placeholder=""><small>+
                                    {{ trans('plugins/auto-content-openai::content.setting.add_more') }}</small></a>
                        </div>
                        <div class="help-ts">
                            <i class="fa fa-info-circle"></i>
                            <a href="https://platform.openai.com/docs/models/model-endpoint-compatibility"
                                target="_blank">{{ trans('plugins/auto-content-openai::content.setting.see_documentation') }}</a>
                        </div>
                    </div>
                    <div class="form-group mb-3">
                        <label class="text-title-field"
                               for="autocontent_openai_image_models">{{ trans('plugins/auto-content-openai::content.setting.openai_image_model') }}
                        </label>
        ...
        <div class="flexbox-annotated-section template-wrapper" id="prompt-template-wrapper">
            <div class="flexbox-annotated-section-annotation">
                <div class="annotated-section-title pd-all-20">
                    <h2>{{ trans('plugins/auto-content-openai::content.setting.generate_default') }}</h2>
                </div>
            </div>
            ...
            <div class="flexbox-annotated-section-content">
                <div class="wrapper-content pd-all-20">
                    <a class="link add-template" href=""><small>
                            + {{ trans('plugins/auto-content-openai::content.setting.add_more') }}</small>
                    </a>
                </div>
            </div>
        </div>
        ...
        <div class="flexbox-annotated-section">
            <div class="flexbox-annotated-section-annotation">
                <div class="annotated-section-title pd-all-20">
                    <h2>{{ trans('plugins/auto-content-openai::content.setting.proxy') }}</h2>
                </div>
                <div class="annotated-section-description pd-all-20 p-none-t">
                    <p class="color-note">{{ trans('plugins/auto-content-openai::content.setting.proxy_description') }}</p>
                </div>
            </div>
            ...
            <div class="flexbox-annotated-section-content">
                <div class="wrapper-content pd-all-20">
                    <div class="form-group mb-3">
                        <label class="text-title-field"
                            for="autocontent_proxy_enable">{{ trans('plugins/auto-content-openai::content.setting.proxy_enable') }}
                        </label>
                        <label class="me-2">
                    ...
                    <div id="autocontent-proxy-settings"
                        ...
                        <div class="form-group mb-3">
                            <label>{{ trans('plugins/auto-content-openai::content.setting.proxy_protocol') }} </label>
                        ...
                        <div class="form-group mb-3">
                            <label>{{ trans('plugins/auto-content-openai::content.setting.proxy_ip') }}</label>
                        ...
                        <div class="form-group mb-3">
                            <label>{{ trans('plugins/auto-content-openai::content.setting.proxy_port') }}</label>
                        ...
                        <div class="form-group mb-3">
                            <label>{{ trans('plugins/auto-content-openai::content.setting.proxy_username') }}</label>
                        ...
                        <div class="form-group mb-3">
                            <label>{{ trans('plugins/auto-content-openai::content.setting.proxy_password') }}</label>
    ...
    <template id="prompt-html-template">
        <div class="mb-4 border rounded-top rounded-bottom p-3 bg-light more-template">
            <div class="form-group mb-3">
                <label class="text-title-field">
                    {{ trans('plugins/auto-content-openai::content.setting.generate_label') }}
                ...
                {!! Form::text('autocontent_prompt_template[][title]', null, [
                    'placeholder' => trans('plugins/auto-content-openai::content.setting.generate_label'),
                    'class' => 'next-input item-title',
                ]) !!}
            </div>
            <div class="form-group mb-3">
                <label class="text-title-field">{{ trans('plugins/auto-content-openai::content.setting.generate_content') }}
                </label>
                {!! Form::textarea('autocontent_prompt_template[][content]', null, [
                    'placeholder' => trans('plugins/auto-content-openai::content.setting.generate_content'),
