...
<button type="button" class="btn btn-primary btn-auto-content btn-auto-content-generate"
    data-load-form="{{ route('auto-content.generate-prompt', ['entity' => $entityType]) }}">{{ trans('plugins/auto-content-openai::content.generate') }}</button>
<button type="button" class="btn btn-primary btn-auto-content btn-auto-content-image"
        data-load-form="{{ route('auto-content.generate-image', ['entity' => $entityType]) }}">{{ trans('plugins/auto-content-openai::content.generate_image') }}</button>
</div>
@pushOnce('footer')
            ...
            <div class="modal-content">
                <div class="modal-header bg-info">
                    <h4 class="modal-title"><i
                            class="til_img"></i><strong>{{ trans('plugins/auto-content-openai::content.form.title') }}</strong>
                    </h4>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-hidden="true"></button>
                </div>

                <div class="modal-body with-padding">
                    @include('plugins/auto-content-openai::generate-content')
                </div>
                ...
                <div class="modal-footer">
                    ...
                    <a class="float-end btn btn-info" id="generate-content"
                        ...
                        href="">{{ trans('plugins/auto-content-openai::content.form.generate') }}</a>
                    <a class="float-end btn btn-success" id="push-content-to-target"
                        href="">{{ trans('plugins/auto-content-openai::content.form.push') }}</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div id="auto-content-image-modal" class="modal fade" tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body with-padding">
                    @include('plugins/auto-content-openai::generate-image')
                </div>
