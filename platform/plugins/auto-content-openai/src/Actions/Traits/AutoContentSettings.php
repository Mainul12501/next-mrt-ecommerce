...
trait AutoContentSettings
{
    ...
    {
        page_title()->setTitle(trans('plugins/auto-content-openai::content.setting.page-title'));

        Assets::addScriptsDirectly([
            'vendor/core/plugins/auto-content-openai/js/settings.js',
        ]);

        return view('plugins/auto-content-openai::settings.index');
    }
