    ...
    public function generate(GenerateRequest $request)
    {
        ...
        if (! OpenAi::checkInitedOpenAi()) {
            return $this->response
                ->setError(true)
                ->setMessage(trans('plugins/auto-content-openai::content.error.OpenAi not initialized'));
        }

        $prompt = trans('plugins/auto-content-openai::content.form.request_output_format')."\n".$prompt;
