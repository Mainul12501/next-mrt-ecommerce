...
(function ($) {
    ...
    *===================================*/
    ...
    $(document).ready(function () {
        $('.dropdown-menu a.dropdown-toggler').on('click', function () {
            ...
            $(this).parents('li.nav-item.dropdown.show').on('hide.bs.dropdown', function () {
        ...
        // Bootstrap 5 dropdowns are auto-initialized
    });
    ...
    *===================================*/
    ...
    function carousel_slider() {
        $('.carousel_slider, .owl-carousel').not('.slick-slider').each(function () {
            let $carousel = $(this);
    ...
    $(document).ready(function () {
        ...
        var carouselList = carouselElList.map(function (carouselEl) {
    ...
    *===================================*/
    ...
    let zoomActive = $('#product_img').data('zoom-enable')
    ...
    $('.product_img_zoom').on('click', function () {
        let actual = $('#product_img').data('zoom-enable') == true ? $('#pr_item_gallery a').attr('data-zoom-image') : $('#pr_item_gallery a').attr('data-image');
        $('body').addClass('zoom_gallery_image');
        $('#pr_item_gallery .item').each(function () {
            let image = $('#product_img').data('zoom-enable') == true ? $(this).find('.product_gallery_item').attr('data-zoom-image') : $(this).find('.product_gallery_item').attr('data-image')
            if (actual === image) {
