    ...
    */
    ...
    'events' => [
        ...
        'beforeRenderTheme' => function (Theme $theme): void {
            ...
            $theme->asset()->usePath()->add('bootstrap-css', 'plugins/bootstrap/css/bootstrap.min.css', version: '5.3.7');
            ...
            $theme->asset()->container('footer')->usePath()->add('bootstrap-js', 'plugins/bootstrap/js/bootstrap.min.js', version: '5.3.7');
            ...
            $theme->asset()->container('footer')->usePath()->add('scripts', 'js/scripts.js', ['jquery', 'carousel-js'], [], $version);
